...
export function BosDurum(props: BosDurumProps) {
  return (
    <>
      ...
      <a className="bg-blue-600/10 text-blue-500 border-r-2 border-blue-500 flex items-center px-4 py-3 ml-2 rounded-l-lg cursor-pointer transition-colors duration-200" href="#">
      <span className="material-symbols-outlined mr-3">dashboard</span>
                      Panel
                  </a>
      <a className="text-slate-400 flex items-center px-4 py-3 ml-2 hover:bg-slate-800/40 rounded-l-lg cursor-pointer hover:bg-slate-800 transition-colors duration-200" href="#">
      ...
      <button className="w-full flex items-center justify-center gap-2 bg-surface-container-highest text-on-surface hover:bg-slate-800 transition-colors duration-200 py-2 rounded-lg border border-outline-variant mb-4">
      <span className="material-symbols-outlined text-[18px]">bolt</span>
                      Hızlı Rapor
                  </button>
      <div className="border-t border-slate-800 pt-4 space-y-sm">
      <a className="text-slate-400 flex items-center px-2 py-2 hover:bg-slate-800/40 rounded-lg cursor-pointer hover:bg-slate-800 transition-colors duration-200" href="#">
      ...
      <input className="w-full bg-surface-container border border-outline-variant rounded-lg pl-10 pr-4 py-2 text-sm text-on-surface focus:border-primary-container focus:ring focus:ring-primary-container/20 transition-all outline-none placeholder:text-slate-500" placeholder="Rezervasyon veya oda ara..." type="text" />
      </div>
      </div>
      {/* Trailing Actions */}
      <div className="flex items-center gap-md font-sans antialiased tracking-tight">
      <button className="text-slate-400 hover:text-white transition-all w-10 h-10 rounded-full flex items-center justify-center hover:bg-slate-800/50 active:scale-95 duration-150">
      ...
      <button className="bg-primary-container text-on-primary-container font-label-md text-label-md px-4 py-2 rounded-lg flex items-center gap-2 hover:brightness-110 active:scale-95 duration-150 transition-all shadow-sm">
      <span className="material-symbols-outlined text-[18px]">add</span>
                          Rezervasyon Ekle
                      </button>
      <div className="ml-2 w-9 h-9 rounded-full bg-surface-container-highest border border-outline-variant overflow-hidden cursor-pointer">
      ...
      {/* Large CTA Button */}
      <button className="bg-primary-container text-on-primary-container font-label-md text-label-md px-xl py-4 rounded-lg flex items-center gap-sm hover:brightness-110 active:scale-95 duration-150 transition-all shadow-lg shadow-primary-container/20 group">
